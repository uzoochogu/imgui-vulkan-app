...
void render_conan_logo()
{
	...
	draw_list->AddBezierCubic(ImVec2(x + 0.72f * sz, y + 0.24f * sz), ImVec2(x + 0.68f * sz, y + 0.15f * sz), ImVec2(x + 0.48f * sz, y + 0.13f * sz), ImVec2(x + 0.39f * sz, y + 0.17f * sz), ImColor(col4), 10, 18);
	draw_list->AddBezierCubic(ImVec2(x + 0.39f * sz, y + 0.17f * sz), ImVec2(x + 0.2f * sz, y + 0.25f * sz), ImVec2(x + 0.3f * sz, y + 0.35f * sz), ImVec2(x + 0.49f * sz, y + 0.38f * sz), ImColor(col4), 10, 18);
}

...
/*It has been modified using CRTP (Curiously recurring Template pattern) we can derive from this (as done in the main.cpp code below and make our custom application). The update and startup functions were modified to fit this CRTP pattern.
*/
...
#include <glad/glad.h>   //needed for OpenGL functions
...
class App
{
  public:
    App()
    {
        ...
        //Was missing, I added it!!! This is very important since I am using glad

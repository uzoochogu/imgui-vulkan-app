// FROM IMGUI 1.90.7 imgui/backends/imgui_impl_vulkan.cpp
...
// third_party_patches/imgui/glsl_shader.vert, compiled with:
...
// third_party_patches/imgui/glsl_shader.vert using approximate code, compiled with:
// # glslangValidator -V -x -o glsl_shader.vert.u32 glsl_shader.vert
/*
#version 450 core
layout(location = 0) in vec2 aPos;
